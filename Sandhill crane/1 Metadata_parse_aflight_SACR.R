...
setwd(file.path('C:', 'Users', 'bpickens','Desktop', 'SACR_detection', 'demo2'))##

# The only input: name of aflight file
input1 <- "20230322_102300.aflight"
...
## Flight folder
a1$flight_name <- gsub('\\',',', a1$flight_name, fixed=TRUE) 
