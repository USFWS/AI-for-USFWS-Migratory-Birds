...
image_path = "C:/users/bpickens/desktop/NPS Channel Islands/"
csv_data = pandas.read_csv("C:/users/bpickens/desktop/NPS Channel Islands/NPS channel islands detection results.csv")

# crops with context exports
export_path_bird = "C:/users/bpickens/desktop/NPS Channel Islands/birds_context_test/"
export_path_nonbird = "F:/crops_w_context_nonbird_test/"
export_path_artif = "F:/crops_w_context_artif_test/"

# crops for inference
# crops with context exports
export_path_bird_i = "C:/users/bpickens/desktop/NPS Channel Islands/bird_inference/"
