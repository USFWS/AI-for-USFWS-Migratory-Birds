...
# Then, manually convert aflight to .xml --- this script will overwrite it
...
setwd(file.path('C:', 'Users', 'bpickens','Desktop', 'Seabird_aflights'))##

##### If conversion to xml is needed...

#file.rename("20230910_115400.aflight", "20230910_115400.xml")

###########################################
xml_address <- "20240127_140200b.xml"

xml_base = substr(xml_address,1,nchar(xml_address)-4)
